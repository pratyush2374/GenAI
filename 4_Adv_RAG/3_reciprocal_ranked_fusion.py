...
def reciprocal_rank_fusion(retrieved_lists, k=60, n=3):
    scores = {}
    for ranking in retrieved_lists:
    ...
    return [doc_map[ids] for ids, _ in sorted_ids][:n]
...
while True:
    ...
    ranked_chunks = reciprocal_rank_fusion(found_chunks)
